...
| `backend` (prod) | `apps/backend/Dockerfile` | Ubuntu 24.04 + tsduck + Node 20: backend spawn tsp con cùng net namespace |
| `frontend` (prod) | `apps/frontend/Dockerfile` | multi-stage, chạy `.next/standalone` user `nextjs` |
